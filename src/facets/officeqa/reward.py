...
--------------------------------------------------------------------------------
Vendored verbatim from the OfficeQA benchmark (https://github.com/databricks/officeqa),
reward.py, which is licensed under Apache-2.0 — the same license as this repository. It is
included unmodified so recipe answers are graded by the *official* scorer (exact + numeric
tolerance matching, with unit awareness), not a re-implementation. See NOTICE for attribution.
--------------------------------------------------------------------------------
"""
